...
SELECT 'subjects' AS table_name, COUNT(*) AS row_count
FROM subjects;
SELECT 'topics' AS table_name, COUNT(*) AS row_count
FROM topics;
SELECT 'content_blocks' AS table_name, COUNT(*) AS row_count
FROM content_blocks;
SELECT 'files' AS table_name, COUNT(*) AS row_count
FROM files;
...
SELECT src.id   AS source_topic,
       cb.title AS block_title,
       tgt.id   AS referenced_topic
FROM content_blocks cb
...
SELECT cb.id                 AS content_block_id,
       src.id                AS source_topic,
